...
New-Item -ItemType Directory -Force -Path "gateway/source/certificate_openssl/ssl/ca" | Out-Null
New-Item -ItemType Directory -Force -Path "gateway/source/certificate_openssl/ssl/cert" | Out-Null
