...
New-Item -ItemType Directory -Force -Path "service/source/certificate_openssl/ssl/ca" | Out-Null
New-Item -ItemType Directory -Force -Path "service/source/certificate_openssl/ssl/cert" | Out-Null
